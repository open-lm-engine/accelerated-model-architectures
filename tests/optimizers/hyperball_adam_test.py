...
from xma import HyperballAdamW, KernelBackend
...
def test_hyperball_adam(
    ...
    hyperball_kernel = HyperballAdamW(
    ...
    hyperball_torch = HyperballAdamW(
        params=params_torch,
        lr=_LEARNING_RATE,
        betas=(0.9, 0.95),
        weight_decay=weight_decay,
    ...
    hyperball_kernel.step(kernel_backend=kernel_backend)
    hyperball_torch.step(kernel_backend=KernelBackend.torch)
